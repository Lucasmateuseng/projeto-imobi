<?php
    ...
    /**
     * Pager.class [ HELPER ]
     * Cópia da class Pager com modificações para padrão bootstrap
    ...
    class Pagination
    {
        ...
        {
            if ($this->Page > 1):
                $nPage = (intval($this->Last) ? $this->Last : 1);
        ...
        private function getSyntax()
        {
            ...
            if ($this->Rows > $this->Limit):
                ...
                $this->Paginator = '<ul class="pagination justify-content-center">';
                $this->Paginator .= '<li class="page-item"><a class="page-link" tabindex="-1" title="' . $this->First . '" href="' . $this->Link . '1">' . $this->First . '</a></li>';
                ...
                $this->Paginator .= '<li class="page-item"><a class="page-link" title="' . $this->Last . '" href="' . $this->Link . $Paginas . '">' . $this->Last . '</a></li>';
                $this->Paginator .= '</ul>';
            endif;
        }
